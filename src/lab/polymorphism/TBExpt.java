...
public class TBExpt {
  ...
  public static void main(String[] args) throws Exception {
    ...
    TextBlock centerTest2 =
        new VComposition(new BoxedBlock(new Centered(new TextLine("Hello"), 21)), numberBlock);
    ...
    TextBlock scrambledTest2 = new VComposition(
        new Centered(new ScrambledRows(new BoxedBlock(new TextLine("Hello"))), 21), numberBlock);
